...
insert into porto values('Sorrento');
insert into porto values('Amalfi');
insert into porto values('Ravenna');
insert into porto values('Pozzuoli');
insert into porto values('Salerno');
insert into porto values('Catania');
insert into porto values('Bari');
insert into porto values('Brindisi');
insert into porto values('Carlo Pisacane');
insert into porto values('Messina');
insert into porto values('Ortona');
insert into porto values('Pozzallo');
insert into porto values('Maratea');
insert into porto values('Livorno');
insert into porto values('Civitavecchia');
insert into porto values('Pesaro');
insert into porto values('Palermo');
insert into porto values('Savona');
insert into porto values('Piombino');
insert into porto values('Cagliari');
insert into porto values('Olbia');
insert into porto values('Genova');
insert into porto values('Flavia');
insert into porto values('Roseto degli Abruzzi');
insert into porto values('Vasto');
